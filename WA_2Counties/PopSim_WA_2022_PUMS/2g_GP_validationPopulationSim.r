...
geographyList   <- c("REGION", "TRACT", "BG", "BLOCK")                                                                                                       #kvm
plotGeographies <- c("REGION", "TRACT", "BG", "BLOCK")                                                                                                               #kvm

geogXWalk       <- read.csv(paste(popSimDir, "/data/geo_cross_walk.csv", sep = "/"))
columnMap       <- read.csv(paste(validationDir, "/data/GP_columnMapPopSim.csv", sep = "/"))
...
summary2           <- read.csv(paste(popSimDir, "/output/final_summary_TRACT.csv", sep = "/"))                            #KVM 9-21-23
summary3           <- read.csv(paste(popSimDir, "/output/final_summary_BG.csv", sep = "/"))
summary4           <- read.csv(paste(popSimDir, "/output/final_summary_BLOCK.csv", sep = "/"))
